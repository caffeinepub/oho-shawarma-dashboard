...
export class Backend implements backendInterface {
    ...
    async createOutlet(arg0: string, arg1: string): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async createUser(arg0: Principal, arg1: string, arg2: string, arg3: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async deleteOutlet(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getAllOutlets(): Promise<Array<Outlet>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllOutlets();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getOutlet(arg0: bigint): Promise<Outlet> {
        if (this.processError) {
            try {
    ...
    async updateOutlet(arg0: bigint, arg1: string, arg2: string): Promise<void> {
        if (this.processError) {
            try {
